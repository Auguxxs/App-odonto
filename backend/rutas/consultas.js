module.exports = function consultasHandler({ consultas, nosotros, pacientes }) {
  return {
    get: (data, callback) => {
      ...
      const consultasConRelaciones = consultas.map((consulta) => ({
        ...consulta,
        paciente: { ...pacientes[consulta.paciente], id: consulta.paciente },
        nosotro: { ...nosotros[consulta.nosotros], id: consulta.nosotros },
      }));
